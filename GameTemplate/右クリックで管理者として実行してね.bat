...
copy "%CURRENT_DIR%\tools\tkExporter.ms" "c:\Program Files\Autodesk\3ds Max 2019\scripts\"
copy "%CURRENT_DIR%\tools\tkExporter.ms" "c:\Program Files\Autodesk\3ds Max 2020\scripts\"
